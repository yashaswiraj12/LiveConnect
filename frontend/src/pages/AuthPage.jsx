      ...
      <div className="auth-left">
        <div className="auth-hero">
          <div className="brand-container">
            <img src="/slack-logo.png" alt="LC" className="brand-logo" />
            <span className="brand-name">LiveConnect</span>
          </div>

          <h1 className="hero-title">Connecting ❤️</h1>
